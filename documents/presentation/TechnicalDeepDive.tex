...
\begin{itemize}[leftmargin=0.3cm]
    \item \textbf{Request Flow:} Client → Nginx → FastAPI → Model Selection
    \item \textbf{Model Hot-Reload:} Environment variable (MODEL\_NAME) switches between variants
    \item \textbf{Docker Deployment:} Port 8000 (FastAPI) | Port 80 (Nginx)
\end{itemize}
